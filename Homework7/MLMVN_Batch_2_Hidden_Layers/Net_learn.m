...
function [hidneur_weights1, hidneur_weights2, outneur_w, iterations, ang_RMSE] = Net_learn(Input, hidneur_num, GlobalThreshold)
...
while (ang_RMSE >= GlobalThreshold && iterations < 1000000)
